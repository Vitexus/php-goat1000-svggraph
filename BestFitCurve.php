...
class BestFitCurve
{
    ...
    protected function buildPaths(
        ...
        if ($project_start) {
            self::buildPath($projection, $fn, 0, $x_min, $y_min, $y_max, $step, $area);
        }

        self::buildPath($line, $fn, $x_min, $x_max, $y_min, $y_max, $step, $area);

        if ($project_end) {
            self::buildPath($projection, $fn, $x_max, $area->width(), $y_min, $y_max, $step, $area);
        }
     ...
     * @param mixed $area
     */
    private static function buildPath(&$path, &$fn, $x1, $x2, $y_min, $y_max, $step, $area): void
    {
        $cmd = 'M';
