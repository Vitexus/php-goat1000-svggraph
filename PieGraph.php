    ...
    public function dataLabelTailDirection($dataset, $index, $hpos, $vpos)
    {
        if (isset($this->slice_info[$index])) {
            ...
            if ($this->getOption('reverse')) {
                return fmod(900 - $this->start_angle - $a, 360);
            }
 ...
 // 900 == 360 + 360 + 180
    ...
    protected function draw()
    {
        ...
        foreach ($values as $value) {
            ...
            $this->slice_info[$original_position] = new SliceInfo(
                $angle_start,
                $angle_end,
                $radius_x,
                $radius_y,
        ...
        usort($legend_entries, static function ($a, $b) {
            return $a[0] - $b[0];
        });
     ...
     * @param mixed $h
     */
    private function setupAspectRatio($w, $h): void
    {
        if ($this->aspect_ratio === 'auto') {
