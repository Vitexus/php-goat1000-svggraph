...
class AxisLog extends Axis
{
    ...
    public function __construct(
        ...
        $this->min_value = $this->base ** $this->lgmin;
        $this->max_value = $this->base ** $this->lgmax;
    }
    ...
    {
        return $this->base ** ($this->lgmin + $position / $this->lgmul);
    }
    ...
    private function findDivision($space, $min_space, $main_division = 0)
    {
        ...
        if ($this->int_base) {
            $division = $main_division ?: $this->base;
            $l = $this->base - 1;
