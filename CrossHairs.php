...
class CrossHairs
{
    ...
    public function getCrossHairs()
    {
      ...
      $svg_text->text('', $font_size, $text_element),
        ...
        $prec_x = $this->graph->getOption(
            'crosshairs_text_precision_h',
            max(0, ceil(log10($scale_x))),
        );
        $prec_y = $this->graph->getOption(
