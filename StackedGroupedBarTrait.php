...
trait StackedGroupedBarTrait
{
    ...
    public function getMaxValue()
    {
        ...
        for ($i = 0; $i < \count($this->groups); ++$i) {
            ...
            [$junk, $group_max] = $values->getMinMaxSumValuesFor($stack);
    ...
    public function getMinValue()
    {
        ...
        for ($i = 0; $i < \count($this->groups); ++$i) {
            ...
            [$group_min] = $values->getMinMaxSumValuesFor($stack);
        ...
        foreach ($this->multi_graph as $bnum => $itemlist) {
            ...
            if ($bar_pos !== null) {
                for ($l = 0; $l < $group_count; ++$l) {
                    ...
                    $end_bar = $this->groups[$l + 1] ?? $bar_count;
                    $ypos = $yneg = 0;
    ...
    protected function barSetup(): void
    {
        ...
        [$group_width, $bspace, $group_unit_width] =
          $this->barPosition(
